...
export interface ApiClientSectionClientSection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clientData: Schema.Attribute.Component<'client-component.client', true> &
...
export interface ApiServicesDropdownMenuServicesDropdownMenu
  extends Struct.CollectionTypeSchema {
  collectionName: 'services_dropdown_menus';
  info: {
    displayName: 'services-dropdown menu';
    pluralName: 'services-dropdown-menus';
    singularName: 'services-dropdown-menu';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::services-dropdown-menu.services-dropdown-menu'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTeamSectionTeamSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    teamMembers: Schema.Attribute.Component<'ui-design.team-members', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::services-dropdown-menu.services-dropdown-menu': ApiServicesDropdownMenuServicesDropdownMenu;
